...
void FreePnextChain(const void *pNext) {
    ...
    switch (header->sType) {
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_PROPERTIES:
            ...
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_SC_1_0_FEATURES:
            delete reinterpret_cast<const safe_VkPhysicalDeviceVulkanSC10Features *>(header);
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_SC_1_0_PROPERTIES:
            delete reinterpret_cast<const safe_VkPhysicalDeviceVulkanSC10Properties *>(header);
            break;
        case VK_STRUCTURE_TYPE_DEVICE_OBJECT_RESERVATION_CREATE_INFO:
            delete reinterpret_cast<const safe_VkDeviceObjectReservationCreateInfo *>(header);
            break;
        case VK_STRUCTURE_TYPE_COMMAND_POOL_MEMORY_RESERVATION_CREATE_INFO:
            delete reinterpret_cast<const safe_VkCommandPoolMemoryReservationCreateInfo *>(header);
            break;
        case VK_STRUCTURE_TYPE_FAULT_CALLBACK_INFO:
            delete reinterpret_cast<const safe_VkFaultCallbackInfo *>(header);
            break;
        case VK_STRUCTURE_TYPE_PIPELINE_OFFLINE_CREATE_INFO:
            delete reinterpret_cast<const safe_VkPipelineOfflineCreateInfo *>(header);
            break;
        case VK_STRUCTURE_TYPE_IMAGE_SWAPCHAIN_CREATE_INFO_KHR:
        ...
        case VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_SUBMIT_INFO_KHR:
            ...
            break;
        case VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_RESERVATION_INFO_KHR:
            delete reinterpret_cast<const safe_VkPerformanceQueryReservationInfoKHR *>(header);
            break;
#ifdef VK_ENABLE_BETA_EXTENSIONS
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PORTABILITY_SUBSET_FEATURES_KHR:
