    ...
    while (pNext) {
        ...
        switch (header->sType) {
            ...
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_SC_1_0_FEATURES:
                safe_pNext = new safe_VkPhysicalDeviceVulkanSC10Features(reinterpret_cast<const VkPhysicalDeviceVulkanSC10Features *>(pNext), copy_state, false);
                break;
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_SC_1_0_PROPERTIES:
                safe_pNext = new safe_VkPhysicalDeviceVulkanSC10Properties(reinterpret_cast<const VkPhysicalDeviceVulkanSC10Properties *>(pNext), copy_state, false);
                break;
            case VK_STRUCTURE_TYPE_DEVICE_OBJECT_RESERVATION_CREATE_INFO:
                safe_pNext = new safe_VkDeviceObjectReservationCreateInfo(reinterpret_cast<const VkDeviceObjectReservationCreateInfo *>(pNext), copy_state, false);
                break;
            case VK_STRUCTURE_TYPE_COMMAND_POOL_MEMORY_RESERVATION_CREATE_INFO:
                safe_pNext = new safe_VkCommandPoolMemoryReservationCreateInfo(reinterpret_cast<const VkCommandPoolMemoryReservationCreateInfo *>(pNext), copy_state, false);
                break;
            case VK_STRUCTURE_TYPE_FAULT_CALLBACK_INFO:
                safe_pNext = new safe_VkFaultCallbackInfo(reinterpret_cast<const VkFaultCallbackInfo *>(pNext), copy_state, false);
                break;
            case VK_STRUCTURE_TYPE_PIPELINE_OFFLINE_CREATE_INFO:
                safe_pNext = new safe_VkPipelineOfflineCreateInfo(reinterpret_cast<const VkPipelineOfflineCreateInfo *>(pNext), copy_state, false);
                break;
            ...
            case VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_RESERVATION_INFO_KHR:
                safe_pNext = new safe_VkPerformanceQueryReservationInfoKHR(reinterpret_cast<const VkPerformanceQueryReservationInfoKHR *>(pNext), copy_state, false);
                break;
            ...
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_QUEUE_PERF_HINT_FEATURES_QCOM:
                safe_pNext = new safe_VkPhysicalDeviceQueuePerfHintFeaturesQCOM(reinterpret_cast<const VkPhysicalDeviceQueuePerfHintFeaturesQCOM *>(pNext), copy_state, false);
                break;
            ...
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_DISPATCH_PARAMETERS_PROPERTIES_ARM:
                safe_pNext = new safe_VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM(reinterpret_cast<const VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM *>(pNext), copy_state, false);
                break;
            ...
            case VK_STRUCTURE_TYPE_APPLICATION_PARAMETERS_EXT:
                safe_pNext = new safe_VkApplicationParametersEXT(reinterpret_cast<const VkApplicationParametersEXT *>(pNext), copy_state, false);
                break;
            ...
            case VK_STRUCTURE_TYPE_THROTTLE_HINT_SUBMIT_INFO_SEC:
                safe_pNext = new safe_VkThrottleHintSubmitInfoSEC(reinterpret_cast<const VkThrottleHintSubmitInfoSEC *>(pNext), copy_state, false);
                break;
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_THROTTLE_HINT_FEATURES_SEC:
                safe_pNext = new safe_VkPhysicalDeviceThrottleHintFeaturesSEC(reinterpret_cast<const VkPhysicalDeviceThrottleHintFeaturesSEC *>(pNext), copy_state, false);
                break;
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DATA_GRAPH_NEURAL_ACCELERATOR_STATISTICS_FEATURES_ARM:
                safe_pNext = new safe_VkPhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM(reinterpret_cast<const VkPhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM *>(pNext), copy_state, false);
                break;
            case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_NEURAL_STATISTICS_CREATE_INFO_ARM:
                safe_pNext = new safe_VkDataGraphPipelineNeuralStatisticsCreateInfoARM(reinterpret_cast<const VkDataGraphPipelineNeuralStatisticsCreateInfoARM *>(pNext), copy_state, false);
                break;
            case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_NEURAL_STATISTICS_CREATE_INFO_ARM:
                safe_pNext = new safe_VkDataGraphPipelineSessionNeuralStatisticsCreateInfoARM(reinterpret_cast<const VkDataGraphPipelineSessionNeuralStatisticsCreateInfoARM *>(pNext), copy_state, false);
                break;
...
void FreePnextChain(const void *pNext) {
    ...
    while (current) {
        ...
        case VK_STRUCTURE_TYPE_RENDERING_INPUT_ATTACHMENT_INDEX_INFO:
            ...
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_SC_1_0_FEATURES:
            delete reinterpret_cast<safe_VkPhysicalDeviceVulkanSC10Features *>(header);
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_SC_1_0_PROPERTIES:
            delete reinterpret_cast<safe_VkPhysicalDeviceVulkanSC10Properties *>(header);
            break;
        case VK_STRUCTURE_TYPE_DEVICE_OBJECT_RESERVATION_CREATE_INFO:
            delete reinterpret_cast<safe_VkDeviceObjectReservationCreateInfo *>(header);
            break;
        case VK_STRUCTURE_TYPE_COMMAND_POOL_MEMORY_RESERVATION_CREATE_INFO:
            delete reinterpret_cast<safe_VkCommandPoolMemoryReservationCreateInfo *>(header);
            break;
        case VK_STRUCTURE_TYPE_FAULT_CALLBACK_INFO:
            delete reinterpret_cast<safe_VkFaultCallbackInfo *>(header);
            break;
        case VK_STRUCTURE_TYPE_PIPELINE_OFFLINE_CREATE_INFO:
            delete reinterpret_cast<safe_VkPipelineOfflineCreateInfo *>(header);
            break;
        case VK_STRUCTURE_TYPE_IMAGE_SWAPCHAIN_CREATE_INFO_KHR:
        ...
        case VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_SUBMIT_INFO_KHR:
            ...
            break;
        case VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_RESERVATION_INFO_KHR:
            delete reinterpret_cast<safe_VkPerformanceQueryReservationInfoKHR *>(header);
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_BFLOAT16_FEATURES_KHR:
        ...
        case VK_STRUCTURE_TYPE_DEVICE_DIAGNOSTICS_CONFIG_CREATE_INFO_NV:
            ...
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_QUEUE_PERF_HINT_FEATURES_QCOM:
            delete reinterpret_cast<safe_VkPhysicalDeviceQueuePerfHintFeaturesQCOM *>(header);
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_QUEUE_PERF_HINT_PROPERTIES_QCOM:
...
#ifdef VK_USE_PLATFORM_SCI
        case VK_STRUCTURE_TYPE_EXPORT_FENCE_SCI_SYNC_INFO_NV:
            delete reinterpret_cast<safe_VkExportFenceSciSyncInfoNV *>(header);
            break;
        case VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_SCI_SYNC_INFO_NV:
            delete reinterpret_cast<safe_VkExportSemaphoreSciSyncInfoNV *>(header);
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SCI_SYNC_FEATURES_NV:
            delete reinterpret_cast<safe_VkPhysicalDeviceExternalSciSyncFeaturesNV *>(header);
            break;
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_SCI_BUF_INFO_NV:
            delete reinterpret_cast<safe_VkExportMemorySciBufInfoNV *>(header);
            break;
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_SCI_BUF_INFO_NV:
            delete reinterpret_cast<safe_VkImportMemorySciBufInfoNV *>(header);
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_SCI_BUF_FEATURES_NV:
            delete reinterpret_cast<safe_VkPhysicalDeviceExternalMemorySciBufFeaturesNV *>(header);
            break;
#endif  // VK_USE_PLATFORM_SCI
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAME_BOUNDARY_FEATURES_EXT:
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_PROPERTIES_ARM:
            ...
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_DISPATCH_PARAMETERS_PROPERTIES_ARM:
            delete reinterpret_cast<safe_VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM *>(header);
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_SLICED_VIEW_OF_3D_FEATURES_EXT:
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINEAR_COLOR_ATTACHMENT_FEATURES_NV:
            ...
            break;
        case VK_STRUCTURE_TYPE_APPLICATION_PARAMETERS_EXT:
            delete reinterpret_cast<safe_VkApplicationParametersEXT *>(header);
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_FEATURES_EXT:
...
#ifdef VK_USE_PLATFORM_SCI
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SCI_SYNC_2_FEATURES_NV:
            delete reinterpret_cast<safe_VkPhysicalDeviceExternalSciSync2FeaturesNV *>(header);
            break;
        case VK_STRUCTURE_TYPE_SEMAPHORE_SCI_SYNC_CREATE_INFO_NV:
            delete reinterpret_cast<safe_VkSemaphoreSciSyncCreateInfoNV *>(header);
            break;
        case VK_STRUCTURE_TYPE_DEVICE_SEMAPHORE_SCI_SYNC_POOL_RESERVATION_CREATE_INFO_NV:
            delete reinterpret_cast<safe_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV *>(header);
            break;
#endif  // VK_USE_PLATFORM_SCI
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_INVOCATION_REORDER_PROPERTIES_NV:
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_MIXED_FLOAT_DOT_PRODUCT_FEATURES_VALVE:
            ...
            break;
        case VK_STRUCTURE_TYPE_THROTTLE_HINT_SUBMIT_INFO_SEC:
            delete reinterpret_cast<safe_VkThrottleHintSubmitInfoSEC *>(header);
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_THROTTLE_HINT_FEATURES_SEC:
            delete reinterpret_cast<safe_VkPhysicalDeviceThrottleHintFeaturesSEC *>(header);
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DATA_GRAPH_NEURAL_ACCELERATOR_STATISTICS_FEATURES_ARM:
            delete reinterpret_cast<safe_VkPhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM *>(header);
            break;
        case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_NEURAL_STATISTICS_CREATE_INFO_ARM:
            delete reinterpret_cast<safe_VkDataGraphPipelineNeuralStatisticsCreateInfoARM *>(header);
            break;
        case VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_NEURAL_STATISTICS_CREATE_INFO_ARM:
            delete reinterpret_cast<safe_VkDataGraphPipelineSessionNeuralStatisticsCreateInfoARM *>(header);
            break;
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIMITIVE_RESTART_INDEX_FEATURES_EXT:
