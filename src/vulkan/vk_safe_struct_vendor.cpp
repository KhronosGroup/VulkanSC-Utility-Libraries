...
safe_VkExportFenceSciSyncInfoNV::safe_VkExportFenceSciSyncInfoNV(const VkExportFenceSciSyncInfoNV* in_struct,
                                                                 [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType), pAttributes(in_struct->pAttributes) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
}
...
safe_VkExportFenceSciSyncInfoNV::safe_VkExportFenceSciSyncInfoNV()
    : sType(VK_STRUCTURE_TYPE_EXPORT_FENCE_SCI_SYNC_INFO_NV), pNext(nullptr), pAttributes() {}
...
safe_VkExportFenceSciSyncInfoNV::~safe_VkExportFenceSciSyncInfoNV() { FreePnextChain(pNext); }
...
safe_VkImportFenceSciSyncInfoNV::safe_VkImportFenceSciSyncInfoNV(const VkImportFenceSciSyncInfoNV* in_struct,
                                                                 [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType), fence(in_struct->fence), handleType(in_struct->handleType), handle(in_struct->handle) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
}
...
safe_VkImportFenceSciSyncInfoNV::safe_VkImportFenceSciSyncInfoNV()
    : sType(VK_STRUCTURE_TYPE_IMPORT_FENCE_SCI_SYNC_INFO_NV), pNext(nullptr), fence(), handleType(), handle(nullptr) {}
...
safe_VkImportFenceSciSyncInfoNV::~safe_VkImportFenceSciSyncInfoNV() { FreePnextChain(pNext); }
...
safe_VkFenceGetSciSyncInfoNV::safe_VkFenceGetSciSyncInfoNV()
    : sType(VK_STRUCTURE_TYPE_FENCE_GET_SCI_SYNC_INFO_NV), pNext(nullptr), fence(), handleType() {}
...
safe_VkFenceGetSciSyncInfoNV::~safe_VkFenceGetSciSyncInfoNV() { FreePnextChain(pNext); }
...
safe_VkSciSyncAttributesInfoNV::safe_VkSciSyncAttributesInfoNV(const VkSciSyncAttributesInfoNV* in_struct,
                                                               [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType), clientType(in_struct->clientType), primitiveType(in_struct->primitiveType) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
}
...
safe_VkSciSyncAttributesInfoNV::safe_VkSciSyncAttributesInfoNV()
    : sType(VK_STRUCTURE_TYPE_SCI_SYNC_ATTRIBUTES_INFO_NV), pNext(nullptr), clientType(), primitiveType() {}
...
safe_VkSciSyncAttributesInfoNV::~safe_VkSciSyncAttributesInfoNV() { FreePnextChain(pNext); }
...
safe_VkExportSemaphoreSciSyncInfoNV::safe_VkExportSemaphoreSciSyncInfoNV()
    : sType(VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_SCI_SYNC_INFO_NV), pNext(nullptr), pAttributes() {}
...
safe_VkExportSemaphoreSciSyncInfoNV& safe_VkExportSemaphoreSciSyncInfoNV::operator=(
    const safe_VkExportSemaphoreSciSyncInfoNV& copy_src) {
    if (&copy_src == this) return *this;
...
safe_VkExportSemaphoreSciSyncInfoNV::~safe_VkExportSemaphoreSciSyncInfoNV() { FreePnextChain(pNext); }
...
safe_VkImportSemaphoreSciSyncInfoNV::safe_VkImportSemaphoreSciSyncInfoNV(const VkImportSemaphoreSciSyncInfoNV* in_struct,
                                                                         [[maybe_unused]] PNextCopyState* copy_state,
                                                                         bool copy_pnext)
    : sType(in_struct->sType), semaphore(in_struct->semaphore), handleType(in_struct->handleType), handle(in_struct->handle) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
}
...
safe_VkImportSemaphoreSciSyncInfoNV::safe_VkImportSemaphoreSciSyncInfoNV()
    : sType(VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_SCI_SYNC_INFO_NV), pNext(nullptr), semaphore(), handleType(), handle(nullptr) {}
...
safe_VkImportSemaphoreSciSyncInfoNV& safe_VkImportSemaphoreSciSyncInfoNV::operator=(
    const safe_VkImportSemaphoreSciSyncInfoNV& copy_src) {
    if (&copy_src == this) return *this;
...
safe_VkImportSemaphoreSciSyncInfoNV::~safe_VkImportSemaphoreSciSyncInfoNV() { FreePnextChain(pNext); }
...
safe_VkSemaphoreGetSciSyncInfoNV::safe_VkSemaphoreGetSciSyncInfoNV()
    : sType(VK_STRUCTURE_TYPE_SEMAPHORE_GET_SCI_SYNC_INFO_NV), pNext(nullptr), semaphore(), handleType() {}
...
safe_VkSemaphoreGetSciSyncInfoNV::~safe_VkSemaphoreGetSciSyncInfoNV() { FreePnextChain(pNext); }
...
safe_VkPhysicalDeviceExternalSciSyncFeaturesNV::safe_VkPhysicalDeviceExternalSciSyncFeaturesNV(
    const VkPhysicalDeviceExternalSciSyncFeaturesNV* in_struct, [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType),
...
safe_VkPhysicalDeviceExternalSciSyncFeaturesNV::safe_VkPhysicalDeviceExternalSciSyncFeaturesNV(
    const safe_VkPhysicalDeviceExternalSciSyncFeaturesNV& copy_src) {
    sType = copy_src.sType;
...
safe_VkPhysicalDeviceExternalSciSyncFeaturesNV& safe_VkPhysicalDeviceExternalSciSyncFeaturesNV::operator=(
    const safe_VkPhysicalDeviceExternalSciSyncFeaturesNV& copy_src) {
    if (&copy_src == this) return *this;
...
safe_VkPhysicalDeviceExternalSciSyncFeaturesNV::~safe_VkPhysicalDeviceExternalSciSyncFeaturesNV() { FreePnextChain(pNext); }
...
safe_VkExportMemorySciBufInfoNV::safe_VkExportMemorySciBufInfoNV()
    : sType(VK_STRUCTURE_TYPE_EXPORT_MEMORY_SCI_BUF_INFO_NV), pNext(nullptr), pAttributes() {}
...
safe_VkExportMemorySciBufInfoNV::~safe_VkExportMemorySciBufInfoNV() { FreePnextChain(pNext); }
...
safe_VkImportMemorySciBufInfoNV::safe_VkImportMemorySciBufInfoNV()
    : sType(VK_STRUCTURE_TYPE_IMPORT_MEMORY_SCI_BUF_INFO_NV), pNext(nullptr), handleType(), handle() {}
...
safe_VkImportMemorySciBufInfoNV::~safe_VkImportMemorySciBufInfoNV() { FreePnextChain(pNext); }
...
safe_VkMemoryGetSciBufInfoNV::safe_VkMemoryGetSciBufInfoNV()
    : sType(VK_STRUCTURE_TYPE_MEMORY_GET_SCI_BUF_INFO_NV), pNext(nullptr), memory(), handleType() {}
...
safe_VkMemoryGetSciBufInfoNV::~safe_VkMemoryGetSciBufInfoNV() { FreePnextChain(pNext); }
...
safe_VkMemorySciBufPropertiesNV::safe_VkMemorySciBufPropertiesNV()
    : sType(VK_STRUCTURE_TYPE_MEMORY_SCI_BUF_PROPERTIES_NV), pNext(nullptr), memoryTypeBits() {}
...
safe_VkMemorySciBufPropertiesNV::~safe_VkMemorySciBufPropertiesNV() { FreePnextChain(pNext); }
...
safe_VkPhysicalDeviceExternalMemorySciBufFeaturesNV::safe_VkPhysicalDeviceExternalMemorySciBufFeaturesNV(
    const VkPhysicalDeviceExternalMemorySciBufFeaturesNV* in_struct, [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType), sciBufImport(in_struct->sciBufImport), sciBufExport(in_struct->sciBufExport) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
}
...
safe_VkPhysicalDeviceExternalMemorySciBufFeaturesNV::safe_VkPhysicalDeviceExternalMemorySciBufFeaturesNV(
    const safe_VkPhysicalDeviceExternalMemorySciBufFeaturesNV& copy_src) {
    sType = copy_src.sType;
...
safe_VkPhysicalDeviceExternalMemorySciBufFeaturesNV& safe_VkPhysicalDeviceExternalMemorySciBufFeaturesNV::operator=(
    const safe_VkPhysicalDeviceExternalMemorySciBufFeaturesNV& copy_src) {
    if (&copy_src == this) return *this;
...
void safe_VkPhysicalDeviceExternalMemorySciBufFeaturesNV::initialize(
    const VkPhysicalDeviceExternalMemorySciBufFeaturesNV* in_struct, [[maybe_unused]] PNextCopyState* copy_state) {
    FreePnextChain(pNext);
    sType = in_struct->sType;
...
void safe_VkPhysicalDeviceExternalMemorySciBufFeaturesNV::initialize(
    const safe_VkPhysicalDeviceExternalMemorySciBufFeaturesNV* copy_src, [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    sciBufImport = copy_src->sciBufImport;
    sciBufExport = copy_src->sciBufExport;
    pNext = SafePnextCopy(copy_src->pNext);
...
safe_VkPhysicalDeviceExternalSciSync2FeaturesNV::safe_VkPhysicalDeviceExternalSciSync2FeaturesNV(
    const VkPhysicalDeviceExternalSciSync2FeaturesNV* in_struct, [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType),
      sciSyncFence(in_struct->sciSyncFence),
      sciSyncSemaphore2(in_struct->sciSyncSemaphore2),
      sciSyncImport(in_struct->sciSyncImport),
      sciSyncExport(in_struct->sciSyncExport) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
...
safe_VkPhysicalDeviceExternalSciSync2FeaturesNV::safe_VkPhysicalDeviceExternalSciSync2FeaturesNV(
    const safe_VkPhysicalDeviceExternalSciSync2FeaturesNV& copy_src) {
    sType = copy_src.sType;
    sciSyncFence = copy_src.sciSyncFence;
    sciSyncSemaphore2 = copy_src.sciSyncSemaphore2;
    sciSyncImport = copy_src.sciSyncImport;
    sciSyncExport = copy_src.sciSyncExport;
    pNext = SafePnextCopy(copy_src.pNext);
}

safe_VkPhysicalDeviceExternalSciSync2FeaturesNV& safe_VkPhysicalDeviceExternalSciSync2FeaturesNV::operator=(
    const safe_VkPhysicalDeviceExternalSciSync2FeaturesNV& copy_src) {
    if (&copy_src == this) return *this;
...
safe_VkPhysicalDeviceExternalSciSync2FeaturesNV::~safe_VkPhysicalDeviceExternalSciSync2FeaturesNV() { FreePnextChain(pNext); }

void safe_VkPhysicalDeviceExternalSciSync2FeaturesNV::initialize(const VkPhysicalDeviceExternalSciSync2FeaturesNV* in_struct,
                                                                 [[maybe_unused]] PNextCopyState* copy_state) {
    FreePnextChain(pNext);
    sType = in_struct->sType;
    sciSyncFence = in_struct->sciSyncFence;
...
void safe_VkPhysicalDeviceExternalSciSync2FeaturesNV::initialize(const safe_VkPhysicalDeviceExternalSciSync2FeaturesNV* copy_src,
                                                                 [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    sciSyncFence = copy_src->sciSyncFence;
    sciSyncSemaphore2 = copy_src->sciSyncSemaphore2;
...
safe_VkSemaphoreSciSyncPoolCreateInfoNV::safe_VkSemaphoreSciSyncPoolCreateInfoNV(
    const VkSemaphoreSciSyncPoolCreateInfoNV* in_struct, [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType), handle(in_struct->handle) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
}
...
safe_VkSemaphoreSciSyncPoolCreateInfoNV::safe_VkSemaphoreSciSyncPoolCreateInfoNV()
    : sType(VK_STRUCTURE_TYPE_SEMAPHORE_SCI_SYNC_POOL_CREATE_INFO_NV), pNext(nullptr), handle() {}

safe_VkSemaphoreSciSyncPoolCreateInfoNV::safe_VkSemaphoreSciSyncPoolCreateInfoNV(
    const safe_VkSemaphoreSciSyncPoolCreateInfoNV& copy_src) {
    sType = copy_src.sType;
    handle = copy_src.handle;
    pNext = SafePnextCopy(copy_src.pNext);
}

safe_VkSemaphoreSciSyncPoolCreateInfoNV& safe_VkSemaphoreSciSyncPoolCreateInfoNV::operator=(
    const safe_VkSemaphoreSciSyncPoolCreateInfoNV& copy_src) {
    if (&copy_src == this) return *this;
...
safe_VkSemaphoreSciSyncPoolCreateInfoNV::~safe_VkSemaphoreSciSyncPoolCreateInfoNV() { FreePnextChain(pNext); }

void safe_VkSemaphoreSciSyncPoolCreateInfoNV::initialize(const VkSemaphoreSciSyncPoolCreateInfoNV* in_struct,
                                                         [[maybe_unused]] PNextCopyState* copy_state) {
    FreePnextChain(pNext);
    sType = in_struct->sType;
    handle = in_struct->handle;
...
void safe_VkSemaphoreSciSyncPoolCreateInfoNV::initialize(const safe_VkSemaphoreSciSyncPoolCreateInfoNV* copy_src,
                                                         [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    handle = copy_src->handle;
    pNext = SafePnextCopy(copy_src->pNext);
...
safe_VkSemaphoreSciSyncCreateInfoNV::safe_VkSemaphoreSciSyncCreateInfoNV(const VkSemaphoreSciSyncCreateInfoNV* in_struct,
                                                                         [[maybe_unused]] PNextCopyState* copy_state,
                                                                         bool copy_pnext)
    : sType(in_struct->sType), semaphorePool(in_struct->semaphorePool), pFence(nullptr) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
    if (in_struct->pFence) {
        pFence = new NvSciSyncFence(*in_struct->pFence);
    }
}

safe_VkSemaphoreSciSyncCreateInfoNV::safe_VkSemaphoreSciSyncCreateInfoNV()
    : sType(VK_STRUCTURE_TYPE_SEMAPHORE_SCI_SYNC_CREATE_INFO_NV), pNext(nullptr), semaphorePool(), pFence(nullptr) {}

safe_VkSemaphoreSciSyncCreateInfoNV::safe_VkSemaphoreSciSyncCreateInfoNV(const safe_VkSemaphoreSciSyncCreateInfoNV& copy_src) {
    sType = copy_src.sType;
    semaphorePool = copy_src.semaphorePool;
    pFence = nullptr;
    pNext = SafePnextCopy(copy_src.pNext);

    if (copy_src.pFence) {
        pFence = new NvSciSyncFence(*copy_src.pFence);
    }
}

safe_VkSemaphoreSciSyncCreateInfoNV& safe_VkSemaphoreSciSyncCreateInfoNV::operator=(
    const safe_VkSemaphoreSciSyncCreateInfoNV& copy_src) {
    if (&copy_src == this) return *this;

    if (pFence) delete pFence;
    FreePnextChain(pNext);
...
void safe_VkSemaphoreSciSyncCreateInfoNV::initialize(const VkSemaphoreSciSyncCreateInfoNV* in_struct,
                                                     [[maybe_unused]] PNextCopyState* copy_state) {
    if (pFence) delete pFence;
    FreePnextChain(pNext);
    sType = in_struct->sType;
    semaphorePool = in_struct->semaphorePool;
    pFence = nullptr;
    pNext = SafePnextCopy(in_struct->pNext, copy_state);
...
void safe_VkSemaphoreSciSyncCreateInfoNV::initialize(const safe_VkSemaphoreSciSyncCreateInfoNV* copy_src,
                                                     [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    semaphorePool = copy_src->semaphorePool;
    pFence = nullptr;
...
safe_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV::safe_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV(
    const VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV* in_struct, [[maybe_unused]] PNextCopyState* copy_state,
    bool copy_pnext)
    : sType(in_struct->sType), semaphoreSciSyncPoolRequestCount(in_struct->semaphoreSciSyncPoolRequestCount) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
}
...
safe_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV::safe_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV(
    const safe_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV& copy_src) {
    sType = copy_src.sType;
    semaphoreSciSyncPoolRequestCount = copy_src.semaphoreSciSyncPoolRequestCount;
    pNext = SafePnextCopy(copy_src.pNext);
}

safe_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV& safe_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV::operator=(
    const safe_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV& copy_src) {
    if (&copy_src == this) return *this;
...
void safe_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV::initialize(
    const VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV* in_struct, [[maybe_unused]] PNextCopyState* copy_state) {
    FreePnextChain(pNext);
    sType = in_struct->sType;
    semaphoreSciSyncPoolRequestCount = in_struct->semaphoreSciSyncPoolRequestCount;
    pNext = SafePnextCopy(in_struct->pNext, copy_state);
}

void safe_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV::initialize(
    const safe_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV* copy_src, [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    semaphoreSciSyncPoolRequestCount = copy_src->semaphoreSciSyncPoolRequestCount;
    pNext = SafePnextCopy(copy_src->pNext);
}
