...
safe_VkPhysicalDeviceVulkanSC10Features::safe_VkPhysicalDeviceVulkanSC10Features(
    const VkPhysicalDeviceVulkanSC10Features* in_struct, [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType), shaderAtomicInstructions(in_struct->shaderAtomicInstructions) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
}
...
safe_VkPhysicalDeviceVulkanSC10Features::safe_VkPhysicalDeviceVulkanSC10Features()
    : sType(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_SC_1_0_FEATURES), pNext(nullptr), shaderAtomicInstructions() {}

safe_VkPhysicalDeviceVulkanSC10Features::safe_VkPhysicalDeviceVulkanSC10Features(
    const safe_VkPhysicalDeviceVulkanSC10Features& copy_src) {
    sType = copy_src.sType;
    shaderAtomicInstructions = copy_src.shaderAtomicInstructions;
    pNext = SafePnextCopy(copy_src.pNext);
}

safe_VkPhysicalDeviceVulkanSC10Features& safe_VkPhysicalDeviceVulkanSC10Features::operator=(
    const safe_VkPhysicalDeviceVulkanSC10Features& copy_src) {
    if (&copy_src == this) return *this;
...
safe_VkPhysicalDeviceVulkanSC10Features::~safe_VkPhysicalDeviceVulkanSC10Features() { FreePnextChain(pNext); }

void safe_VkPhysicalDeviceVulkanSC10Features::initialize(const VkPhysicalDeviceVulkanSC10Features* in_struct,
                                                         [[maybe_unused]] PNextCopyState* copy_state) {
    FreePnextChain(pNext);
    sType = in_struct->sType;
    shaderAtomicInstructions = in_struct->shaderAtomicInstructions;
    pNext = SafePnextCopy(in_struct->pNext, copy_state);
}

void safe_VkPhysicalDeviceVulkanSC10Features::initialize(const safe_VkPhysicalDeviceVulkanSC10Features* copy_src,
                                                         [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    shaderAtomicInstructions = copy_src->shaderAtomicInstructions;
    pNext = SafePnextCopy(copy_src->pNext);
...
safe_VkPhysicalDeviceVulkanSC10Properties::safe_VkPhysicalDeviceVulkanSC10Properties(
    const VkPhysicalDeviceVulkanSC10Properties* in_struct, [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType),
      deviceNoDynamicHostAllocations(in_struct->deviceNoDynamicHostAllocations),
      deviceDestroyFreesMemory(in_struct->deviceDestroyFreesMemory),
      commandPoolMultipleCommandBuffersRecording(in_struct->commandPoolMultipleCommandBuffersRecording),
      commandPoolResetCommandBuffer(in_struct->commandPoolResetCommandBuffer),
      commandBufferSimultaneousUse(in_struct->commandBufferSimultaneousUse),
      secondaryCommandBufferNullOrImagelessFramebuffer(in_struct->secondaryCommandBufferNullOrImagelessFramebuffer),
      recycleDescriptorSetMemory(in_struct->recycleDescriptorSetMemory),
      recyclePipelineMemory(in_struct->recyclePipelineMemory),
      maxRenderPassSubpasses(in_struct->maxRenderPassSubpasses),
      maxRenderPassDependencies(in_struct->maxRenderPassDependencies),
      maxSubpassInputAttachments(in_struct->maxSubpassInputAttachments),
      maxSubpassPreserveAttachments(in_struct->maxSubpassPreserveAttachments),
...
safe_VkPhysicalDeviceVulkanSC10Properties::safe_VkPhysicalDeviceVulkanSC10Properties(
    const safe_VkPhysicalDeviceVulkanSC10Properties& copy_src) {
    sType = copy_src.sType;
    deviceNoDynamicHostAllocations = copy_src.deviceNoDynamicHostAllocations;
    deviceDestroyFreesMemory = copy_src.deviceDestroyFreesMemory;
    commandPoolMultipleCommandBuffersRecording = copy_src.commandPoolMultipleCommandBuffersRecording;
    commandPoolResetCommandBuffer = copy_src.commandPoolResetCommandBuffer;
    commandBufferSimultaneousUse = copy_src.commandBufferSimultaneousUse;
    secondaryCommandBufferNullOrImagelessFramebuffer = copy_src.secondaryCommandBufferNullOrImagelessFramebuffer;
    recycleDescriptorSetMemory = copy_src.recycleDescriptorSetMemory;
    recyclePipelineMemory = copy_src.recyclePipelineMemory;
    maxRenderPassSubpasses = copy_src.maxRenderPassSubpasses;
    maxRenderPassDependencies = copy_src.maxRenderPassDependencies;
    maxSubpassInputAttachments = copy_src.maxSubpassInputAttachments;
    maxSubpassPreserveAttachments = copy_src.maxSubpassPreserveAttachments;
    maxFramebufferAttachments = copy_src.maxFramebufferAttachments;
...
safe_VkPhysicalDeviceVulkanSC10Properties& safe_VkPhysicalDeviceVulkanSC10Properties::operator=(
    const safe_VkPhysicalDeviceVulkanSC10Properties& copy_src) {
    if (&copy_src == this) return *this;
...
safe_VkPhysicalDeviceVulkanSC10Properties::~safe_VkPhysicalDeviceVulkanSC10Properties() { FreePnextChain(pNext); }

void safe_VkPhysicalDeviceVulkanSC10Properties::initialize(const VkPhysicalDeviceVulkanSC10Properties* in_struct,
                                                           [[maybe_unused]] PNextCopyState* copy_state) {
    FreePnextChain(pNext);
    sType = in_struct->sType;
    deviceNoDynamicHostAllocations = in_struct->deviceNoDynamicHostAllocations;
...
void safe_VkPhysicalDeviceVulkanSC10Properties::initialize(const safe_VkPhysicalDeviceVulkanSC10Properties* copy_src,
                                                           [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    deviceNoDynamicHostAllocations = copy_src->deviceNoDynamicHostAllocations;
    deviceDestroyFreesMemory = copy_src->deviceDestroyFreesMemory;
...
safe_VkPipelinePoolSize::safe_VkPipelinePoolSize(const VkPipelinePoolSize* in_struct, [[maybe_unused]] PNextCopyState* copy_state,
                                                 bool copy_pnext)
    : sType(in_struct->sType), poolEntrySize(in_struct->poolEntrySize), poolEntryCount(in_struct->poolEntryCount) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
}

safe_VkPipelinePoolSize::safe_VkPipelinePoolSize()
    : sType(VK_STRUCTURE_TYPE_PIPELINE_POOL_SIZE), pNext(nullptr), poolEntrySize(), poolEntryCount() {}

safe_VkPipelinePoolSize::safe_VkPipelinePoolSize(const safe_VkPipelinePoolSize& copy_src) {
    sType = copy_src.sType;
    poolEntrySize = copy_src.poolEntrySize;
    poolEntryCount = copy_src.poolEntryCount;
    pNext = SafePnextCopy(copy_src.pNext);
}

safe_VkPipelinePoolSize& safe_VkPipelinePoolSize::operator=(const safe_VkPipelinePoolSize& copy_src) {
    if (&copy_src == this) return *this;
...
safe_VkPipelinePoolSize::~safe_VkPipelinePoolSize() { FreePnextChain(pNext); }

void safe_VkPipelinePoolSize::initialize(const VkPipelinePoolSize* in_struct, [[maybe_unused]] PNextCopyState* copy_state) {
    FreePnextChain(pNext);
    sType = in_struct->sType;
    poolEntrySize = in_struct->poolEntrySize;
    poolEntryCount = in_struct->poolEntryCount;
    pNext = SafePnextCopy(in_struct->pNext, copy_state);
}

void safe_VkPipelinePoolSize::initialize(const safe_VkPipelinePoolSize* copy_src, [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    poolEntrySize = copy_src->poolEntrySize;
    poolEntryCount = copy_src->poolEntryCount;
    pNext = SafePnextCopy(copy_src->pNext);
...
safe_VkDeviceObjectReservationCreateInfo::safe_VkDeviceObjectReservationCreateInfo(
    const VkDeviceObjectReservationCreateInfo* in_struct, [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType),
      pipelineCacheCreateInfoCount(in_struct->pipelineCacheCreateInfoCount),
      pPipelineCacheCreateInfos(nullptr),
      pipelinePoolSizeCount(in_struct->pipelinePoolSizeCount),
      pPipelinePoolSizes(nullptr),
      semaphoreRequestCount(in_struct->semaphoreRequestCount),
      commandBufferRequestCount(in_struct->commandBufferRequestCount),
      fenceRequestCount(in_struct->fenceRequestCount),
      deviceMemoryRequestCount(in_struct->deviceMemoryRequestCount),
      bufferRequestCount(in_struct->bufferRequestCount),
      imageRequestCount(in_struct->imageRequestCount),
      eventRequestCount(in_struct->eventRequestCount),
      queryPoolRequestCount(in_struct->queryPoolRequestCount),
      bufferViewRequestCount(in_struct->bufferViewRequestCount),
      imageViewRequestCount(in_struct->imageViewRequestCount),
      layeredImageViewRequestCount(in_struct->layeredImageViewRequestCount),
      pipelineCacheRequestCount(in_struct->pipelineCacheRequestCount),
      pipelineLayoutRequestCount(in_struct->pipelineLayoutRequestCount),
      renderPassRequestCount(in_struct->renderPassRequestCount),
      graphicsPipelineRequestCount(in_struct->graphicsPipelineRequestCount),
      computePipelineRequestCount(in_struct->computePipelineRequestCount),
      descriptorSetLayoutRequestCount(in_struct->descriptorSetLayoutRequestCount),
      samplerRequestCount(in_struct->samplerRequestCount),
      descriptorPoolRequestCount(in_struct->descriptorPoolRequestCount),
      descriptorSetRequestCount(in_struct->descriptorSetRequestCount),
      framebufferRequestCount(in_struct->framebufferRequestCount),
      commandPoolRequestCount(in_struct->commandPoolRequestCount),
      samplerYcbcrConversionRequestCount(in_struct->samplerYcbcrConversionRequestCount),
      surfaceRequestCount(in_struct->surfaceRequestCount),
      swapchainRequestCount(in_struct->swapchainRequestCount),
      displayModeRequestCount(in_struct->displayModeRequestCount),
      subpassDescriptionRequestCount(in_struct->subpassDescriptionRequestCount),
      attachmentDescriptionRequestCount(in_struct->attachmentDescriptionRequestCount),
      descriptorSetLayoutBindingRequestCount(in_struct->descriptorSetLayoutBindingRequestCount),
      descriptorSetLayoutBindingLimit(in_struct->descriptorSetLayoutBindingLimit),
      maxImageViewMipLevels(in_struct->maxImageViewMipLevels),
      maxImageViewArrayLayers(in_struct->maxImageViewArrayLayers),
      maxLayeredImageViewMipLevels(in_struct->maxLayeredImageViewMipLevels),
      maxOcclusionQueriesPerPool(in_struct->maxOcclusionQueriesPerPool),
      maxPipelineStatisticsQueriesPerPool(in_struct->maxPipelineStatisticsQueriesPerPool),
      maxTimestampQueriesPerPool(in_struct->maxTimestampQueriesPerPool),
      maxImmutableSamplersPerDescriptorSetLayout(in_struct->maxImmutableSamplersPerDescriptorSetLayout) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
    if (pipelineCacheCreateInfoCount && in_struct->pPipelineCacheCreateInfos) {
        pPipelineCacheCreateInfos = new safe_VkPipelineCacheCreateInfo[pipelineCacheCreateInfoCount];
        for (uint32_t i = 0; i < pipelineCacheCreateInfoCount; ++i) {
            pPipelineCacheCreateInfos[i].initialize(&in_struct->pPipelineCacheCreateInfos[i]);
        }
    }
    if (pipelinePoolSizeCount && in_struct->pPipelinePoolSizes) {
        pPipelinePoolSizes = new safe_VkPipelinePoolSize[pipelinePoolSizeCount];
        for (uint32_t i = 0; i < pipelinePoolSizeCount; ++i) {
            pPipelinePoolSizes[i].initialize(&in_struct->pPipelinePoolSizes[i]);
        }
    }
}
...
safe_VkDeviceObjectReservationCreateInfo::safe_VkDeviceObjectReservationCreateInfo(
    const safe_VkDeviceObjectReservationCreateInfo& copy_src) {
    sType = copy_src.sType;
    pipelineCacheCreateInfoCount = copy_src.pipelineCacheCreateInfoCount;
    pPipelineCacheCreateInfos = nullptr;
    pipelinePoolSizeCount = copy_src.pipelinePoolSizeCount;
    pPipelinePoolSizes = nullptr;
    semaphoreRequestCount = copy_src.semaphoreRequestCount;
    commandBufferRequestCount = copy_src.commandBufferRequestCount;
    fenceRequestCount = copy_src.fenceRequestCount;
    deviceMemoryRequestCount = copy_src.deviceMemoryRequestCount;
    bufferRequestCount = copy_src.bufferRequestCount;
    imageRequestCount = copy_src.imageRequestCount;
    eventRequestCount = copy_src.eventRequestCount;
    queryPoolRequestCount = copy_src.queryPoolRequestCount;
    bufferViewRequestCount = copy_src.bufferViewRequestCount;
    imageViewRequestCount = copy_src.imageViewRequestCount;
    layeredImageViewRequestCount = copy_src.layeredImageViewRequestCount;
    pipelineCacheRequestCount = copy_src.pipelineCacheRequestCount;
    pipelineLayoutRequestCount = copy_src.pipelineLayoutRequestCount;
    renderPassRequestCount = copy_src.renderPassRequestCount;
    graphicsPipelineRequestCount = copy_src.graphicsPipelineRequestCount;
    computePipelineRequestCount = copy_src.computePipelineRequestCount;
    descriptorSetLayoutRequestCount = copy_src.descriptorSetLayoutRequestCount;
    samplerRequestCount = copy_src.samplerRequestCount;
    descriptorPoolRequestCount = copy_src.descriptorPoolRequestCount;
    descriptorSetRequestCount = copy_src.descriptorSetRequestCount;
    framebufferRequestCount = copy_src.framebufferRequestCount;
    commandPoolRequestCount = copy_src.commandPoolRequestCount;
    samplerYcbcrConversionRequestCount = copy_src.samplerYcbcrConversionRequestCount;
    surfaceRequestCount = copy_src.surfaceRequestCount;
    swapchainRequestCount = copy_src.swapchainRequestCount;
    displayModeRequestCount = copy_src.displayModeRequestCount;
    subpassDescriptionRequestCount = copy_src.subpassDescriptionRequestCount;
    attachmentDescriptionRequestCount = copy_src.attachmentDescriptionRequestCount;
    descriptorSetLayoutBindingRequestCount = copy_src.descriptorSetLayoutBindingRequestCount;
    descriptorSetLayoutBindingLimit = copy_src.descriptorSetLayoutBindingLimit;
    maxImageViewMipLevels = copy_src.maxImageViewMipLevels;
    maxImageViewArrayLayers = copy_src.maxImageViewArrayLayers;
    maxLayeredImageViewMipLevels = copy_src.maxLayeredImageViewMipLevels;
    maxOcclusionQueriesPerPool = copy_src.maxOcclusionQueriesPerPool;
    maxPipelineStatisticsQueriesPerPool = copy_src.maxPipelineStatisticsQueriesPerPool;
    maxTimestampQueriesPerPool = copy_src.maxTimestampQueriesPerPool;
    maxImmutableSamplersPerDescriptorSetLayout = copy_src.maxImmutableSamplersPerDescriptorSetLayout;
    pNext = SafePnextCopy(copy_src.pNext);
    if (pipelineCacheCreateInfoCount && copy_src.pPipelineCacheCreateInfos) {
        pPipelineCacheCreateInfos = new safe_VkPipelineCacheCreateInfo[pipelineCacheCreateInfoCount];
        for (uint32_t i = 0; i < pipelineCacheCreateInfoCount; ++i) {
            pPipelineCacheCreateInfos[i].initialize(&copy_src.pPipelineCacheCreateInfos[i]);
        }
    }
    if (pipelinePoolSizeCount && copy_src.pPipelinePoolSizes) {
        pPipelinePoolSizes = new safe_VkPipelinePoolSize[pipelinePoolSizeCount];
        for (uint32_t i = 0; i < pipelinePoolSizeCount; ++i) {
            pPipelinePoolSizes[i].initialize(&copy_src.pPipelinePoolSizes[i]);
        }
    }
}

safe_VkDeviceObjectReservationCreateInfo& safe_VkDeviceObjectReservationCreateInfo::operator=(
    const safe_VkDeviceObjectReservationCreateInfo& copy_src) {
    if (&copy_src == this) return *this;

    if (pPipelineCacheCreateInfos) delete[] pPipelineCacheCreateInfos;
    if (pPipelinePoolSizes) delete[] pPipelinePoolSizes;
    FreePnextChain(pNext);
...
void safe_VkDeviceObjectReservationCreateInfo::initialize(const VkDeviceObjectReservationCreateInfo* in_struct,
                                                          [[maybe_unused]] PNextCopyState* copy_state) {
    if (pPipelineCacheCreateInfos) delete[] pPipelineCacheCreateInfos;
    if (pPipelinePoolSizes) delete[] pPipelinePoolSizes;
    FreePnextChain(pNext);
...
void safe_VkDeviceObjectReservationCreateInfo::initialize(const safe_VkDeviceObjectReservationCreateInfo* copy_src,
                                                          [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    pipelineCacheCreateInfoCount = copy_src->pipelineCacheCreateInfoCount;
    pPipelineCacheCreateInfos = nullptr;
...
safe_VkCommandPoolMemoryReservationCreateInfo::safe_VkCommandPoolMemoryReservationCreateInfo(
    const VkCommandPoolMemoryReservationCreateInfo* in_struct, [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType),
      commandPoolReservedSize(in_struct->commandPoolReservedSize),
      commandPoolMaxCommandBuffers(in_struct->commandPoolMaxCommandBuffers) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
}
...
safe_VkCommandPoolMemoryReservationCreateInfo::safe_VkCommandPoolMemoryReservationCreateInfo(
    const safe_VkCommandPoolMemoryReservationCreateInfo& copy_src) {
    sType = copy_src.sType;
    commandPoolReservedSize = copy_src.commandPoolReservedSize;
    commandPoolMaxCommandBuffers = copy_src.commandPoolMaxCommandBuffers;
    pNext = SafePnextCopy(copy_src.pNext);
}

safe_VkCommandPoolMemoryReservationCreateInfo& safe_VkCommandPoolMemoryReservationCreateInfo::operator=(
    const safe_VkCommandPoolMemoryReservationCreateInfo& copy_src) {
    if (&copy_src == this) return *this;
...
safe_VkCommandPoolMemoryReservationCreateInfo::~safe_VkCommandPoolMemoryReservationCreateInfo() { FreePnextChain(pNext); }

void safe_VkCommandPoolMemoryReservationCreateInfo::initialize(const VkCommandPoolMemoryReservationCreateInfo* in_struct,
                                                               [[maybe_unused]] PNextCopyState* copy_state) {
    FreePnextChain(pNext);
    sType = in_struct->sType;
    commandPoolReservedSize = in_struct->commandPoolReservedSize;
...
void safe_VkCommandPoolMemoryReservationCreateInfo::initialize(const safe_VkCommandPoolMemoryReservationCreateInfo* copy_src,
                                                               [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    commandPoolReservedSize = copy_src->commandPoolReservedSize;
    commandPoolMaxCommandBuffers = copy_src->commandPoolMaxCommandBuffers;
...
safe_VkCommandPoolMemoryConsumption::safe_VkCommandPoolMemoryConsumption(const VkCommandPoolMemoryConsumption* in_struct,
                                                                         [[maybe_unused]] PNextCopyState* copy_state,
                                                                         bool copy_pnext)
    : sType(in_struct->sType),
      commandPoolAllocated(in_struct->commandPoolAllocated),
      commandPoolReservedSize(in_struct->commandPoolReservedSize),
      commandBufferAllocated(in_struct->commandBufferAllocated) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
}

safe_VkCommandPoolMemoryConsumption::safe_VkCommandPoolMemoryConsumption()
...
safe_VkCommandPoolMemoryConsumption::safe_VkCommandPoolMemoryConsumption(const safe_VkCommandPoolMemoryConsumption& copy_src) {
    sType = copy_src.sType;
    commandPoolAllocated = copy_src.commandPoolAllocated;
    commandPoolReservedSize = copy_src.commandPoolReservedSize;
    commandBufferAllocated = copy_src.commandBufferAllocated;
    pNext = SafePnextCopy(copy_src.pNext);
}

safe_VkCommandPoolMemoryConsumption& safe_VkCommandPoolMemoryConsumption::operator=(
    const safe_VkCommandPoolMemoryConsumption& copy_src) {
    if (&copy_src == this) return *this;
...
safe_VkCommandPoolMemoryConsumption::~safe_VkCommandPoolMemoryConsumption() { FreePnextChain(pNext); }

void safe_VkCommandPoolMemoryConsumption::initialize(const VkCommandPoolMemoryConsumption* in_struct,
                                                     [[maybe_unused]] PNextCopyState* copy_state) {
    FreePnextChain(pNext);
    sType = in_struct->sType;
    commandPoolAllocated = in_struct->commandPoolAllocated;
...
void safe_VkCommandPoolMemoryConsumption::initialize(const safe_VkCommandPoolMemoryConsumption* copy_src,
                                                     [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    commandPoolAllocated = copy_src->commandPoolAllocated;
    commandPoolReservedSize = copy_src->commandPoolReservedSize;
...
safe_VkFaultData::safe_VkFaultData(const VkFaultData* in_struct, [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType), faultLevel(in_struct->faultLevel), faultType(in_struct->faultType) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
}

safe_VkFaultData::safe_VkFaultData() : sType(VK_STRUCTURE_TYPE_FAULT_DATA), pNext(nullptr), faultLevel(), faultType() {}

safe_VkFaultData::safe_VkFaultData(const safe_VkFaultData& copy_src) {
    sType = copy_src.sType;
    faultLevel = copy_src.faultLevel;
    faultType = copy_src.faultType;
    pNext = SafePnextCopy(copy_src.pNext);
}

safe_VkFaultData& safe_VkFaultData::operator=(const safe_VkFaultData& copy_src) {
    if (&copy_src == this) return *this;
...
safe_VkFaultData::~safe_VkFaultData() { FreePnextChain(pNext); }

void safe_VkFaultData::initialize(const VkFaultData* in_struct, [[maybe_unused]] PNextCopyState* copy_state) {
    FreePnextChain(pNext);
    sType = in_struct->sType;
    faultLevel = in_struct->faultLevel;
    faultType = in_struct->faultType;
    pNext = SafePnextCopy(in_struct->pNext, copy_state);
}

void safe_VkFaultData::initialize(const safe_VkFaultData* copy_src, [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    faultLevel = copy_src->faultLevel;
    faultType = copy_src->faultType;
    pNext = SafePnextCopy(copy_src->pNext);
...
safe_VkFaultCallbackInfo::safe_VkFaultCallbackInfo(const VkFaultCallbackInfo* in_struct,
                                                   [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType), faultCount(in_struct->faultCount), pFaults(nullptr), pfnFaultCallback(in_struct->pfnFaultCallback) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
    if (faultCount && in_struct->pFaults) {
        pFaults = new safe_VkFaultData[faultCount];
        for (uint32_t i = 0; i < faultCount; ++i) {
            pFaults[i].initialize(&in_struct->pFaults[i]);
        }
    }
}

safe_VkFaultCallbackInfo::safe_VkFaultCallbackInfo()
    : sType(VK_STRUCTURE_TYPE_FAULT_CALLBACK_INFO), pNext(nullptr), faultCount(), pFaults(nullptr), pfnFaultCallback() {}

safe_VkFaultCallbackInfo::safe_VkFaultCallbackInfo(const safe_VkFaultCallbackInfo& copy_src) {
    sType = copy_src.sType;
    faultCount = copy_src.faultCount;
    pFaults = nullptr;
    pfnFaultCallback = copy_src.pfnFaultCallback;
    pNext = SafePnextCopy(copy_src.pNext);
    if (faultCount && copy_src.pFaults) {
        pFaults = new safe_VkFaultData[faultCount];
        for (uint32_t i = 0; i < faultCount; ++i) {
            pFaults[i].initialize(&copy_src.pFaults[i]);
        }
    }
}

safe_VkFaultCallbackInfo& safe_VkFaultCallbackInfo::operator=(const safe_VkFaultCallbackInfo& copy_src) {
    if (&copy_src == this) return *this;

    if (pFaults) delete[] pFaults;
    FreePnextChain(pNext);
...
void safe_VkFaultCallbackInfo::initialize(const VkFaultCallbackInfo* in_struct, [[maybe_unused]] PNextCopyState* copy_state) {
    if (pFaults) delete[] pFaults;
    FreePnextChain(pNext);
    sType = in_struct->sType;
    faultCount = in_struct->faultCount;
    pFaults = nullptr;
    pfnFaultCallback = in_struct->pfnFaultCallback;
    pNext = SafePnextCopy(in_struct->pNext, copy_state);
    if (faultCount && in_struct->pFaults) {
        pFaults = new safe_VkFaultData[faultCount];
        for (uint32_t i = 0; i < faultCount; ++i) {
...
void safe_VkFaultCallbackInfo::initialize(const safe_VkFaultCallbackInfo* copy_src, [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    faultCount = copy_src->faultCount;
    pFaults = nullptr;
    pfnFaultCallback = copy_src->pfnFaultCallback;
...
safe_VkPipelineOfflineCreateInfo::safe_VkPipelineOfflineCreateInfo(const VkPipelineOfflineCreateInfo* in_struct,
                                                                   [[maybe_unused]] PNextCopyState* copy_state, bool copy_pnext)
    : sType(in_struct->sType), matchControl(in_struct->matchControl), poolEntrySize(in_struct->poolEntrySize) {
    if (copy_pnext) {
        pNext = SafePnextCopy(in_struct->pNext, copy_state);
    }
    for (uint32_t i = 0; i < VK_UUID_SIZE; ++i) {
...
safe_VkPipelineOfflineCreateInfo::safe_VkPipelineOfflineCreateInfo()
    : sType(VK_STRUCTURE_TYPE_PIPELINE_OFFLINE_CREATE_INFO), pNext(nullptr), matchControl(), poolEntrySize() {}

safe_VkPipelineOfflineCreateInfo::safe_VkPipelineOfflineCreateInfo(const safe_VkPipelineOfflineCreateInfo& copy_src) {
    sType = copy_src.sType;
    matchControl = copy_src.matchControl;
    poolEntrySize = copy_src.poolEntrySize;
    pNext = SafePnextCopy(copy_src.pNext);
...
safe_VkPipelineOfflineCreateInfo& safe_VkPipelineOfflineCreateInfo::operator=(const safe_VkPipelineOfflineCreateInfo& copy_src) {
    if (&copy_src == this) return *this;
...
safe_VkPipelineOfflineCreateInfo::~safe_VkPipelineOfflineCreateInfo() { FreePnextChain(pNext); }

void safe_VkPipelineOfflineCreateInfo::initialize(const VkPipelineOfflineCreateInfo* in_struct,
                                                  [[maybe_unused]] PNextCopyState* copy_state) {
    FreePnextChain(pNext);
    sType = in_struct->sType;
    matchControl = in_struct->matchControl;
    poolEntrySize = in_struct->poolEntrySize;
    pNext = SafePnextCopy(in_struct->pNext, copy_state);
...
void safe_VkPipelineOfflineCreateInfo::initialize(const safe_VkPipelineOfflineCreateInfo* copy_src,
                                                  [[maybe_unused]] PNextCopyState* copy_state) {
    sType = copy_src->sType;
    matchControl = copy_src->matchControl;
    poolEntrySize = copy_src->poolEntrySize;
